...
?>
		<?php 
			...
			if ( array_search('page-template-approved_product_landing', $body_classes) ) {
				//echo 'this is a lando';
		?>
			<div class="copyrightDisclaimer">
				<div class="copyrightDisclaimer__inner">
					<p><?= $title ?><sup>®</sup> is a registered trademark owned or licensed by Eli Lilly and Company, its subsidiaries, or affiliates.</p>
				</div>
			</div>
		<?php		
			}
		...
		<footer id="site-footer" role="contentinfo" class="footer">
			<div class="footer-container">
				<a href="https://www.lilly.com/" target="_blank" class="logo">
					<div class="container">
				...
				<div class="footer_disclaimer footer_disclaimer--urgency">
					<p>Urgency Anonymous<sup>™</sup> is a trademark owned or licensed by Eli Lilly and Company, its subsidiaries, or affiliates.</p>
					<p>&nbsp;</p>
				</div>
				<div class="footer_disclaimer">
				<!-- <div class="columns">
					<div class="column column--left">
						<p>This content has been approved consistent with the US FDA. You can report US Lilly product related AE/PCs at 1-800-LillyRx (1-800-545-5979). For Adverse Events and/or Product Complaints (AE/PC) outside of the US, please report per your local country requirements. Visit a region-specific or country-specific Lilly-owned website for more information on how to report.</p>
					</div>
				...
				<p>VV-Centralized Congress-US-DEL-0461 01/2022 © Lilly USA, LLC 2022. All rights reserved. This site is intended for US Healthcare Professionals Only.</p>
		...
		<?php wp_footer(); ?>
		<script async id="gdpr" src="<?php echo get_bloginfo('url'); ?>/wp-content/themes/lilly_tradeshow/ibex/js/libs/gdpr.js" data-message="This site uses cookies. Read more in our <a href='https://www.lillyhub.com/legal/lillyusa/english/privacy.html' target='_blank'>Privacy Policy</a>"></script>
		<script>
			// AOS.init();
		</script>
	</body>
