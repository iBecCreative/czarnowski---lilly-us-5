...
// JS locations
var js_concat_import      = ['./js/libs/feature.js', './js/libs/doubletaptogo.js', './js/libs/jquery.mediaWrapper.js', './js/libs/tableit.js', './js/libs/blazy.min.js', './js/libs/ofi.min.js', './js/script.js'];
...
gulp.task('default', ['sass', 'scripts', 'uglify', 'imagemin', 'svgmin', 'svgSprite', 'bs'], function () {
  ...
  gulp.watch([svg_import, img_import], ['imagemin', 'svgmin']);
...
// Compile SCSS / watch
gulp.task('nobs', ['scripts', 'uglify', 'imagemin', 'svgmin', 'svgSprite'], function () {
...
gulp.task('bs', function () {
  ...
  gulp.watch(scss_import).on('change', browserSync.reload);
