...
<main id="site-content" role="main">
  ...
  <div class="comingSoon__content">
    ...
    <div class="comingSoon__countdown">
      <ul class="countdown">
        <li class="countdown__value countdown__value--days">
          <p id="days" class="countdown__digit"></p>
          <p class="countdown__label">DAYS</p>
        </li>
        <li class="countdown__value countdown__value--hours">
          <p id="hours" class="countdown__digit"></p>
          <p class="countdown__label">HOURS</p>
        </li>
        <li class="countdown__value countdown__value--minutes">
          <p id="minutes" class="countdown__digit"></p>
          <p class="countdown__label">MINUTES</p>
        </li>
        <li class="countdown__value countdown__value--seconds">
          <p id="seconds" class="countdown__digit"></p>
  ...
  <footer id="site-footer--comingSoon" role="contentinfo" class="footer">
    <div class="footer_disclaimer">VV-OTHR-US-DEL-0930 05/2022 © Lilly USA, LLC 2022. All rights reserved.</div>
  </footer>
</main><!-- #site-content -->
...
<script>
  ...
  const deadline = 'May 23 2022 09:00:00 GMT-0400';
